...
eadk_color_t all_palettes = {&palette_peanut_GB,&palette_original,&palette_gray, &palette_gray_negative, &palette_virtual_boy,&palette_virtual_boy_inv,&palette_worst_ever};
